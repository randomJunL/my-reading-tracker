...
api_router.include_router(reader_access.router, tags=["reader access"])
api_router.include_router(reader_access.caregiver_router, tags=["caregiver access"])
api_router.include_router(book_search.router, tags=["book search"])
api_router.include_router(book_recommendations.router, tags=["recommendations"])

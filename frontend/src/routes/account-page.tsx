...
export function AccountPage() {
  const { isDevAuthBypass, updatePassword, user } = useAuth();
    ...
    <section className="animate-[fade-in_350ms_ease-out]">
      <div className="mb-8">
        ...
        <p className="mt-2 max-w-xl text-sm leading-6 text-[#667b74] sm:text-base">
          Review who you’re signed in as and manage your password.
        </p>
      </div>
        ...
        <Card className="p-6 sm:p-7">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#6b7e77]">Your current access</p>
            </div>
          </div>

          <dl className="mt-6 divide-y divide-[#e7e4da] text-sm">
            <Detail label="Name" value={displayName || "Not provided"} />
            <Detail
              label="Email"

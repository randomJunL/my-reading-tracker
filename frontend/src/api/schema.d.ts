...
export interface paths {
  ...
  "/api/v1/readers/{reader_id}/books/import": {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    put?: never;
    /** Create Reader Book */
    post: operations["create_reader_book_api_v1_readers__reader_id__books_import_post"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface operations {
  ...
  create_reader_book_api_v1_readers__reader_id__books_import_post: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ReaderBookImport"];
      };
    };
    responses: {
      /** @description Successful Response */
